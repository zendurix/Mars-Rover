    ...
    : ComplexObject3d(Vec3::zero(), Vec3::zero())
{
    ...
    Sphere branches1 = Sphere(5.0,  Vec3(pos_x+3.0, pos_y, -20.0 - 2.0), Vec3::zero(), normalize_rgb(Vec3(50, 235, 50)));
    Sphere branches2 = Sphere(5.0,  Vec3(pos_x, pos_y + 5.0, -20.0), Vec3::zero(), normalize_rgb(Vec3(50, 225, 50)));
    Sphere branches3 = Sphere(5.0,  Vec3(pos_x- 3.0, pos_y + 1.0, -20.0), Vec3::zero(), normalize_rgb(Vec3(50, 225, 70)));
